        ...
        if (resultCode == RESULT_OK) {
            when (requestCode) {
                this.requestCode -> {
                    ...
                    val setting = Gson().fromJson(SharedStorage.initSetting.toString(), NewsSetting::class.java)
